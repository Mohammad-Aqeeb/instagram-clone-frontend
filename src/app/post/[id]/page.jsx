    ...
    <div className={styles.container}>
      <div key={post.id} className={styles.postCard}>
        <div className={styles.postUserHeader}>
          ...
          <p className={styles.username} onClick={() => router.push(`/profile/${post.user?.username}`)}>
            {post.user.username}
          </p>
        </div>
        <img src={post.file?.url} alt={post.caption} className={styles.image} />
        <div className={styles.postUserLikeCommentsSaveContainer}>
          <div className={styles.postUserLikeCommentsContainer}>
            <div className={styles.postUserLikeContainer}>
              ...
              <div
                className={styles.postUserLikeCount}
                onClick={() => {
                  router.push(`/post/${post.id}/likes`);
                }}
              >
                {post.like.length}
              </div>
